...
Description: If the WP_ENV constant is 'development', disables plugins that you specify
Version: 0.1
...
if ( defined( 'WP_SERVER_ENVIRONMENT' ) && WP_SERVER_ENVIRONMENT == 'development' ) {
	new CWS_Disable_Plugins_When_Local_Dev( array( 'backwpup/backwpup.php' ) );
	/*
